...
/**
 * Prevent the wire from creating comment river entries
 *
 * @return array
 */
function thewire_river_handler($hook, $type, $value, $params) {
	if ($value['subtype'] == 'thewire' && $value['action_type'] == 'comment') {
		return false;
	}
	return $value;
}
